 ...
 * 	    (d) Also a method to get all the values under a column header   
 * 2. ExcelWriteClass
 ...
 * 
 * EASY EXAMPLE TO MAKE CALLS TO THE ABOVE METHODS --> (BEFORE MAKING CALLS create the objects with the constructor type paramters)
 ...
 * 		ExcelReadClass read = new ExcelReadClass(propertiesFilePath,excelFilePath,excelSheetName);
 ...
 * 	 	ExcelWriteClass write = new ExcelWriteClass(propertiesFilePath,excelFilePath,excelSheetName);
 ...
 *
 *
 * Get List of values under a column header --> returns a linked list
 *		
 *		ExcelReadClass readPageObj = new ExcelReadClass(globalPropertiesFilePath, excelFilePath, excelSheetName);
 *		LinkedList<String> lList = readPageObj.getDataFromExcelColumn("header15");
